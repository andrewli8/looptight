...
<style>
:root{--ink:#dce7df;--muted:#829087;--panel:#101713;--line:#5a6f63;--acid:#c6ff3d;--amber:#ffbd59;--red:#ff6b5f;--cyan:#63e6df}
...
<body>
<header><h1><span>LOOPTIGHT // LOCAL CONTROL</span>Swarm Signal</h1><div class="live" id="connection" role="status" aria-live="polite">connecting</div></header>
<main><div class="tally" id="tally" role="status" aria-live="polite" aria-label="Swarm status tally"></div><div class="controls"><div class="filters" aria-label="Filter nodes by status"><button class="filter" data-filter="all" aria-pressed="true">all</button><button class="filter" data-filter="active" aria-pressed="false">active</button><button class="filter" data-filter="attention" aria-pressed="false">attention</button><button class="filter" data-filter="complete" aria-pressed="false">complete</button></div><div class="inspector" id="inspector" role="status" aria-live="polite"><strong>No node selected</strong><span>Choose a node for details.</span></div></div><section class="graph" id="graph" aria-label="Swarm orchestration graph"><svg class="wires" aria-hidden="true"><defs><marker id="arrow" markerWidth="7" markerHeight="7" refX="6" refY="3.5" orient="auto"><path d="M0,0 L7,3.5 L0,7z" fill="#5a6f63"/></marker></defs><g id="wires"></g></svg><div class="lane" id="manager" role="group" aria-labelledby="manager-title"><div class="lane-title" id="manager-title">manager</div></div><div class="lane" id="tasks" role="group" aria-labelledby="tasks-title"><div class="lane-title" id="tasks-title">tasks</div></div><div class="lane" id="workers" role="group" aria-labelledby="workers-title"><div class="lane-title" id="workers-title">workers</div></div></section></main>
<footer>READ ONLY · LOOPBACK INTERFACE · STATE SCHEMA <span id="schema">—</span> · LAST EVENT <span id="age">UNKNOWN</span></footer>
<script>
const $=id=>document.getElementById(id);
let state={schema_version:1,manager:{status:'idle'},tasks:[],workers:[]},filter='all',selected=null,records={},lastTallyKey='',lastInspectorKey='';
